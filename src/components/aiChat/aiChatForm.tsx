      ...
      >
        <div className="relative flex flex-col w-full px-8 overflow-hidden max-h-60 grow bg-background rounded-md border sm:px-12">
          <textarea
            ...
            className="w-full resize-none bg-transparent px-4 py-[1.3rem] focus-within:outline-none sm:text-sm h-auto"
            value={input}
            onChange={handleChange}
            onKeyDown={handleEnter}
            placeholder="무엇을 도와드릴까요?"
          />
          <button type="submit" className="absolute p-5 right-2">
            <AiOutlineEnter />
          </button>
        </div>
        <input
