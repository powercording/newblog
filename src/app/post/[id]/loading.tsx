export default async function PostLoading() {
  return (
    <main className="h-screen">
      <header className="mt-12 min-h-fit border-b-gray-400 border-b py-2 animate-pulse bg-white">
      ...
      <div className="grid grid-cols-3 w-full 2xl:w-3/4 justify-items-center mx-auto gap-2 p-5 h-full">
        <article className="col-span-3 lg:col-span-2 w-full h-3/4 bg-gray-200 rounded-md animate-pulse p-5 flex flex-col gap-3">
          <div className="bg-gray-400 w-96 h-10 rounded-md"></div>
          <div className="bg-gray-50 w-full h-6 rounded-md"></div>
          <div className="bg-gray-100 w-36 h-6 rounded-md"></div>
        </article>
